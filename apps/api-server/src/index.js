...
app.get('/api/dashboard/summary', async (_req, res) => {
  ...
  res.json({
    ...
    trafficSources: [
      { id: 't1', label: 'Organic Search', value: 42, change: 5.2, color: '#6366f1' },
      { id: 't2', label: 'Direct', value: 28, change: -1.3, color: '#0ea5e9' },
      { id: 't3', label: 'Referral', value: 16, change: 8.7, color: '#10b981' },
      { id: 't4', label: 'Social', value: 9, change: 12.1, color: '#f59e0b' },
      { id: 't5', label: 'Email', value: 5, change: 2.4, color: '#ec4899' },
    ],
    topProducts: [
...
const analyticsOverviewByPeriod = {
  '7d': {
    ...
    channels: [
      { id: 'c1', label: 'Organic Search', value: 38, change: 4.2, color: '#6366f1' },
      { id: 'c2', label: 'Direct', value: 26, change: -2.1, color: '#0ea5e9' },
      { id: 'c3', label: 'Paid Ads', value: 18, change: 12.4, color: '#10b981' },
      { id: 'c4', label: 'Social', value: 12, change: 8.9, color: '#f59e0b' },
      { id: 'c5', label: 'Email', value: 6, change: 1.2, color: '#ec4899' },
    ],
    hourlyTrend: [
  ...
  '30d': {
    ...
    channels: [
      { id: 'c1', label: 'Organic Search', value: 42, change: 5.2, color: '#6366f1' },
      { id: 'c2', label: 'Direct', value: 28, change: -1.3, color: '#0ea5e9' },
      { id: 'c3', label: 'Paid Ads', value: 14, change: 9.8, color: '#10b981' },
      { id: 'c4', label: 'Social', value: 11, change: 6.4, color: '#f59e0b' },
      { id: 'c5', label: 'Email', value: 5, change: 2.1, color: '#ec4899' },
    ],
    hourlyTrend: [
  ...
  '90d': {
    ...
    channels: [
      { id: 'c1', label: 'Organic Search', value: 40, change: 3.8, color: '#6366f1' },
      { id: 'c2', label: 'Direct', value: 30, change: 0.5, color: '#0ea5e9' },
      { id: 'c3', label: 'Paid Ads', value: 16, change: 15.2, color: '#10b981' },
      { id: 'c4', label: 'Social', value: 10, change: 4.2, color: '#f59e0b' },
      { id: 'c5', label: 'Email', value: 4, change: 0.8, color: '#ec4899' },
    ],
    hourlyTrend: [
  ...
  '12m': {
    ...
    channels: [
      { id: 'c1', label: 'Organic Search', value: 44, change: 8.2, color: '#6366f1' },
      { id: 'c2', label: 'Direct', value: 26, change: 2.1, color: '#0ea5e9' },
      { id: 'c3', label: 'Paid Ads', value: 15, change: 22.4, color: '#10b981' },
      { id: 'c4', label: 'Social', value: 10, change: 18.2, color: '#f59e0b' },
      { id: 'c5', label: 'Email', value: 5, change: 4.8, color: '#ec4899' },
    ],
    hourlyTrend: [
