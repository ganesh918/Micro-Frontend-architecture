...
const iconMap: Record<ActivityItem['type'], { icon: React.ReactNode; color: string }> = {
  user: { icon: <User size={14} />, color: '#6366f1' },
  system: { icon: <RefreshCw size={14} />, color: '#0ea5e9' },
  alert: { icon: <AlertTriangle size={14} />, color: '#f59e0b' },
  update: { icon: <Settings size={14} />, color: '#10b981' },
};
